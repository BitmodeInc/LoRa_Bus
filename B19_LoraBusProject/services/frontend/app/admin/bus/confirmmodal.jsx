...
const ConfirmModal = ({ isOpen, onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md mx-2 sm:mx-auto">
        <h2 className="text-2xl font-bold text-red-600 dark:text-red-400 mb-4">Warning!!!!</h2>
        <p className="mb-6 dark:text-gray-300">Are you sure you want to delete this bus ?</p>
