...
if (!TOKEN_SECRET_KEY || !REFRESH_TOKEN_SECRET_KEY || !JWT_SALT) {
  throw new Error("TOKEN_SECRET_KEY, REFRESH_TOKEN_SECRET_KEY, and JWT_SALT must be set.");
}

console.log(TOKEN_SECRET_KEY)
console.log(REFRESH_TOKEN_SECRET_KEY)
console.log(JWT_SALT)
